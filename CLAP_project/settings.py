"""
Django settings for CLAP_project project.
...
SECRET_KEY = 'django-insecure-+^jk3e+_)eab4!lrm22=31i2*8s+t57i*e_9)^*^8z^9bx=sai'
...
ROOT_URLCONF = 'CLAP_project.urls'
...
WSGI_APPLICATION = 'CLAP_project.wsgi.application'
